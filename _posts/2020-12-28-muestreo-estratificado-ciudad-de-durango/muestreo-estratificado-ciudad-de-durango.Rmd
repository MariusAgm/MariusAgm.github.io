...
```{r strata-divide, echo=TRUE, include=TRUE}
Nh_prop <- Nh/sum(Nh)
...
### Elige tus estratos de manera práctica

El lector con más experiencia práctica se podría dar cuenta con este post que esta distribución resulta un tanto impráctica, pues tendríamos que tener bien identificadas a las personas por su lugar de trabajo. En el caso, por ejemplo de los no especificados, tenemos que localizar a 5 personas en todo el municipio que no cumplan con las otras características de los estratos.

Por esta razón, es necesario tener conocimiento práctico de la zona en la que se está haciendo el trabajo de investigación.
